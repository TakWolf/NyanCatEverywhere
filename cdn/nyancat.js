...
(function() {
    ...
    function Cat() {
        ...
        this.img.src = 'http://nyan.takwolf.com/img/nyancat.gif';
    ...
    function load() {
        ...
        bgm.src = 'http://nyan.takwolf.com/bgm/nyancat.mp3';
        bgm.autoplay = 'autoplay';
        bgm.loop = 'loop'; /* FIXME : this is not work , I don't know why */
        window.setInterval(function() {
            bgm.src = 'http://nyan.takwolf.com/bgm/nyancat.mp3'; /* FIXME : only this way can work , I am crazy !!! */
        }, 27097.687);
    }
